...
from multimanifoldSMOTE4 import neighborhood_Measure_mm
...
def over_multi_manifold(data, global_data, mapper=None, min_class_size=5,
                        ...
                        mapping_mode='normal',
                        k_sim=3, k_opp=3, top_n_opp_classes=3):  # ✅ 添加
...
def over_classify_mlp(data, train_mlp_once_func,
                      ...
                      mapping_mode='normal',
                      k_sim=3, k_opp=3, top_n_opp_classes=3):  # ✅ 添加这三个参数
    ...
    if final_new_samples:
        ...
        if final_new_samples_filtered:
            ...
            print("✅ 最终增强数据已保存为 final_multiclass_augmented4.csv")
...
def save_final_augmented_data(original_data, final_new_samples, filename="final_multiclass_augmented4.csv"):
    print("📦 正在保存最终增强训练集...")
