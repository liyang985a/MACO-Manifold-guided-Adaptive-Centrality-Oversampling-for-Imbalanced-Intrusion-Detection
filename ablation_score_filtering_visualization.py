...
# 2. 加载数据
# =========================================================
df = pd.read_csv("score_filter_ablation_results.csv")
metrics = ["F1", "Precision", "MCC", "G-means"]

# 简化配色：使用高对比度、色盲友好的 Tableau 颜色
colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728']
markers = ['o', 's', '^', 'D']  # 为每个指标设置不同标记，增加区分度
...
plt.title("Effect of Score-Based Filtering on Multi-Manifold Oversampling",
...
# =========================================================
print("⏳ 正在保存高分辨率图片...")
plt.savefig("score_filter_ablation_line_plot.pdf", format='pdf', bbox_inches='tight')
plt.savefig("score_filter_ablation_line_plot.png", dpi=600, bbox_inches='tight')
print("✅ 图片保存成功！")
